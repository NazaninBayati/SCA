...
class fileMetrics(MainMetrics.Metrics):
    ...
    def main(self,db):
        ...
        MainMetrics.Metrics.printresult('file Report',final_list,11,'Filename,ProgrammingLanguage,FileQualifiedname,Location,Metrics,ContainedFunctions,ContainedClasses,calledFiles,CalledByFiles')
